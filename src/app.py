...
activities = {
    ...
    "Soccer Practice": {
        "description": "Team soccer training with drills and scrimmages",
    ...
    "Art Studio": {
        ...
        "max_participants": 16,
        "participants": ["chloe@mergington.edu", "nathan@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting, stagecraft, and performance rehearsals",
        "schedule": "Tuesdays and Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["samantha@mergington.edu", "ryan@mergington.edu"]
    },
    "Science Club": {
